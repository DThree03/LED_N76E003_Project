...
#define bitRead(value, bt) (((value) >> (bt)) & 0x01)
#define bitSet(value, bt) ((value) |= (1UL << (bt)))
#define bitClear(value, bt) ((value) &= ~(1UL << (bt)))
#define bitWrite(value, bt, bitvalue) (bitvalue ? bitSet(value, bt) : bitClear(value, bt))

//16 --> 8 x 2
#define HIBYTE(v1)              ((unsigned char)((v1)>>8))                      //v1 is unsigned int
#define LOBYTE(v1)              ((unsigned char)((v1)&0xFF))
//8 x 2 --> 16
#define MAKEWORD(v1,v2)         ((((unsigned int)(v1))<<8)+(unsigned int)(v2))      //v1,v2 is unsigned char
//8 x 4 --> 32
#define MAKELONG(v1,v2,v3,v4)   (unsigned long)((v1<<32)+(v2<<16)+(v3<<8)+v4)  //v1,v2,v3,v4 is unsigned char
//32 --> 16 x 2
#define YBYTE1(v1)              ((unsigned int)((v1)>>16))                    //v1 is unsigned long
#define YBYTE0(v1)              ((unsigned int)((v1)&0xFFFF))
//32 --> 8 x 4
#define TBYTE3(v1)              ((unsigned char)((v1)>>24))                     //v1 is unsigned long
